package com.example.administrator.glasshouse.ui.temperature
...
import com.example.administrator.glasshouse.util.Config
import com.github.mikephil.charting.data.*
import io.reactivex.disposables.CompositeDisposable
import kotlinx.android.synthetic.main.fragment_temperature_detail.*

class TemperatureDetailFragment : androidx.fragment.app.Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.fragment_temperature_detail, container, false)
...
//        dataset.colors=ColorTemplate.COLORFUL_COLORS
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        back_from_temperature.setOnClickListener {
            it.findNavController().popBackStack()
        }

        chart.description.text = "Biểu đồ nhiệt độ"
        setData(24)
    }

    private fun setData(count: Int) {
        val fakeData = listOf<Float>(23f, 23f, 22f,23f,24f,23f,23f,24f,24f,26f,27f,28f,29f,29f,29f,30f,29f,28f,27f,26f,25f,25f,24f,23f)
        val yValues = ArrayList<BarEntry>()
        for (i in 1..count) {
            yValues.add(BarEntry(i.toFloat(), fakeData[i - 1]))
        }

        val set = BarDataSet(yValues,"Nhiệt dộ")

//        set.colors=ColorTemplate.MATERIAL_COLORS as List<Int>
