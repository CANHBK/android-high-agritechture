package com.example.administrator.glasshouse.ui.sensor
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.layout.setOnClickListener {
            ...
            when (sensor.index()!!.toInt()) {
                1 -> it.findNavController().navigate(R.id.action_sensorFragment_to_fragment_monitor_detail)
                2 -> it.findNavController().navigate(R.id.action_sensorFragment_to_lightDetailFragment)
                3-> it.findNavController().navigate(R.id.action_sensorFragment_to_airHumidityFragment)
                4 -> it.findNavController().navigate(R.id.action_sensorFragment_to_groundHumidityFragment)
            }
